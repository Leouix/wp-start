...
{
    wp_enqueue_style('bedrock-theme-style', get_stylesheet_uri(), array(), _S_VERSION);
    wp_style_add_data('bedrock-theme-style', 'rtl', 'replace');

    wp_enqueue_script(
        'bedrock-theme-navigation',
    ...
    wp_enqueue_style(
        'bedrock-bootstrap-style',
        get_path_theme_modules() . '/bootstrap/dist/css/bootstrap.min.css',
        array(),
        _S_VERSION
    );
    ...
    wp_enqueue_script(
        'bedrock-bootstrap',
        get_path_theme_modules() . '/bootstrap/dist/js/bootstrap.bundle.min.js',
        array(),
        _S_VERSION,
        true
    );
...
add_action('the_content', 'show_filter_products');

function show_filter_products()
{
    if (is_shop()) :
        include('template-parts/productFilters/topHeader.php');
    endif;
}
